...
MNEMONIC: str = 'here should be your twelve of twenty four length mnemonic seed phrase' # generate_mnemonic(language="english", strength=128)

# Secret passphrase/password for mnemonic
PASSPHRASE: Optional[str] = None  # "strong-passphrase-password" if you have any

# Initialize Cosmos mainnet BIP44HDWallet
bip44_hdwallet: BIP44HDWallet = BIP44HDWallet(cryptocurrency=AtomMainnet)

# Get Cosmos BIP44HDWallet from mnemonic
...
# Get Cosmos BIP44HDWallet information's from address index
address_index = 100
